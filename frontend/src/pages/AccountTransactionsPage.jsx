          ...
          <Card key={index} sx={{ mb: 2, width: "100%" }}>
            <CardContent>
              ...
              >
                <Box>
                  <Typography>
                    sent from Account ID: {transaction.senderAcc._id}
                  </Typography>
                  <Typography>
                    (User: {transaction.senderAcc.userId})
                  </Typography>
                  <Typography>
                    to Account ID: {transaction.receiverAcc._id}
                  </Typography>
                  <Typography>
                    (User: {transaction.receiverAcc.userId})
                  </Typography>
                </Box>
                <Box>
                  <Typography
                    sx={{ textAlign: { xs: "left", md: "right" }, mt: 8 }}
                  >
